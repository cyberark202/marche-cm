...
urlpatterns = [
    ...
    path(
        ...
        AuthDisabledView.as_view() if settings.AUTH_LOCKDOWN else PasswordResetRequestView.as_view(),
        name="auth-password-reset-request",
    ),
    path(
        "api/auth/password/reset/confirm/",
        AuthDisabledView.as_view() if settings.AUTH_LOCKDOWN else PasswordResetConfirmView.as_view(),
